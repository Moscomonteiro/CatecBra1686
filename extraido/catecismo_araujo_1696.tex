...
\begin{alternate}
    \item Marã gatú etépe acé Tupã rauçôbi, bäé
        tetirúáçocé?
    \item Ombãé çocé, ogûba, ocy, oecobé, öäyra,
...
\section{DIALOGO X.}
\unskip\vspace{2pt}
\subsection{Do primeiro Mandamento da Igreja.}

\chaptermark{Dialogo X.}
\sectionmark{Ouvir Mi\lgSS a}
\vspace*{6pt}
...
\begin{altereven}
    ...
    \item Ara imombäéetépyra pupé Mi\lgSS a rendû-
        ...
        bo.
    \item Marã pe acé recóu Mi\lgSS a recêé oieäpyça-
        cá catú potá?
...
\begin{alternate}
    ...
    \item  Noiemöapycykixoéne, tëõ äîba çüí\linebreak
        onhëangüâbo.
    \item  Marã ëípe abá tëõ çúí onhëangüâbo,\linebreak
...
\section{DIALOGO XII.}
\unskip\vspace{2pt}
\subsection{Do terceiro Mandamento da Igreja.}

\chaptermark{Dialogo XII.}
\sectionmark{Commungar pela Pa\lgS coa.}
\vspace*{-6pt}

\comecalista{M.}{D.}{M}{A}
{rã ëípe imocçapyra ?\\
Pa\lgS coa iabiõ Tupã râra, ëí.
}
...
%\unskip\vspace{-0pt}
\unskip\vspace*{2pt}
\section{DIALOGO XIII.}
\unskip\vspace{2pt}
\subsection{Do quarto Mandamento da Igreja.}

\chaptermark{Dialogo XIII.}
\sectionmark{Do Iejum.}
\vspace*{-4pt}

\comecalista{M.}{}{M}{A}
{rã ëípe amó àé Sãta Madre Igre-\linebreak
\hspace*{1.5ex}ja acerecómonhangâba oieyrun-\\
\hspace*{7ex}dyc cycâpe ?
}
...
\hspace*{0ex}\begin{minipage}[t]{1.08\linewidth}
    \lettrine
    [findent =-2pt, nindent=0pt, loversize=-0.2, lraise=0.05, lines=5]
    {\zall{M}}{O}co\~i oioïrucdyc oito âra cyke-
...
catã cyapuãbäé, Myrrha moçânga töó çúí.
...
\begin{center}
    ...
    Aos 2.A Purificaçaô da Virgem Senhora No\lgSS a\\
    da guarda.}
\end{center}
\unskip
...
Tupã Tàba çupé icuabêênga, Judeos reco-
...
{\hspace*{-2ex}Có Saõ Jo\lgS eph âra imóetepyramo cecóu.
